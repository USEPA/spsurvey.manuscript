...
\Shorttitle{\pkg{spsurvey}: Spatial Sampling Design and Analysis in
\proglang{R}}
...
\Keywords{design-based inference, generalized random-tessellation
stratified algorithm, Horvitz-Thompson, inclusion probability, spatial
balance, variance estimation}
\Plainkeywords{design-based inference, generalized random-tessellation
stratified algorithm, Horvitz-Thompson, inclusion probability, spatial
balance, variance estimation}
